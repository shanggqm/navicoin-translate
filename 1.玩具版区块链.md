...
## 结论
Naviecoin现在还只是一个玩具“通用”区块链。此外，本章还介绍了如果用简单的方式实现区块链的一些基本原理。[下一章](http://lhartikk.github.io/jekyll/update/2017/07/13/chapter2.html)我们将把权益证明算法（挖矿）添加到naivecoin中。
